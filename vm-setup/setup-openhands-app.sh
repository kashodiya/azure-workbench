...
if ! sudo -u azureuser docker images | grep -q "docker.all-hands.dev/all-hands-ai/runtime.*0.50-nikolaik"; then
    echo "[OPENHANDS-APP] Pulling runtime image..."
    sudo -u azureuser docker pull docker.all-hands.dev/all-hands-ai/runtime:0.50-nikolaik
else
