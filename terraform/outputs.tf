...
VM_FQDN="${coalesce(azurerm_public_ip.main.fqdn, "pending")}"
SSH_COMMAND_FQDN="ssh -i private_key.pem ${var.admin_username}@${coalesce(azurerm_public_ip.main.fqdn, azurerm_public_ip.main.ip_address)}"
